  ...
  useEffect(() => {
    ...
    return(
      ...
      <div>
        ...
        <form className="mx-auto my-4 border-3 p-3 " style={{maxWidth: '500px'}} onSubmit={handleSubmit}>
          ...
          <p className="my-2">
            Belum Punya Akun ? <Link href="/registers"><a style={{color: 'crimson'}}>Daftar</a></Link>
          </p>
        </form>
      </div>
      </Layouts>
